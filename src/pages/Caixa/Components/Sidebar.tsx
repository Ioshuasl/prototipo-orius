...
export const menuConfig: MenuItemConfig[] = [
    ...
    },
    {
        ...
        path: 'servicos-realizados'
    },
    {
        title: 'Selos',
        icon: StampIcon,
        subItems: [
            { label: 'Lotes de Selo', path: 'lotes-selo'},
    ...
    },
    {
        ...
        icon: PrinterIcon,
        subItems : [
            { label: 'Receita e Despesa', path: 'impressao/relatorio-receita-depesa'},
            { label: 'Serviços Realizados', path: 'impressao/relatorio-servicos-realizados'},
