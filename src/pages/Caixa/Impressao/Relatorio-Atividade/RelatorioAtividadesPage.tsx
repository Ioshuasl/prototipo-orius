...
import ModalConfiguracaoImpressao, { type Configuracao} from './Components/ModalConfiguracaoImpressao';
...
export default function RelatorioAtividadesPage() {
    ...
    const [configuracaoImpressao, setConfiguracaoImpressao] = useState<Configuracao>({
        colunas: { userId: true, dataHora: true, acao: true, detalhes: true},
