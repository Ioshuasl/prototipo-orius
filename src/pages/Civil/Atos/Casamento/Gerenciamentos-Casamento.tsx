...
// --- Dados simulados (lógica inalterada) ---
...
// Estilos de status permanecem para boa UX
...
export default function MarriageRecordsManagementPage() {
                ...
                <div className={`bg-white rounded-lg border border-gray-200 transition-all duration-300 hover:shadow-xl hover:border-gray-300 overflow-hidden`}>
                    <div className="p-4 border-b border-gray-100">
                        <div className="flex justify-between items-start gap-4">
                            ...
                            <div><h3 className="font-bold text-gray-800 text-lg leading-tight group-hover:transition-colors">{record.groomName} <span className="text-gray-400 font-normal">&</span> {record.brideName}</h3><p className="text-sm text-gray-500">{record.cpfGroom} | {record.cpfBride}</p></div>
    ...
    return (
        <>
            <title>Gerenciamento de Casamentos | Orius Tecnologia</title>
            <div className="flex bg-gray-50 min-h-screen font-sans">
                <main className="flex-1">
                    <div className="mx-auto space-y-4">
                        <header className="flex items-center justify-between">
                             {/* ALTERADO: Cor do título e do botão principal */}
                            <div><h1 className="text-3xl font-bold text-[#4a4e51]">Gerenciamento de Casamentos</h1><p className="text-md text-gray-500 mt-1">Consulte e gerencie os registros de casamento.</p></div>
                            <Link to="/registro-civil/casamento/cadastrar" className="flex items-center gap-2 bg-[#dd6825] text-white font-semibold px-4 py-2 rounded-lg shadow-sm hover:bg-[#c25a1f] transition-all duration-300 hover:scale-105"><PlusCircle className="h-5 w-5" /> Registrar Novo</Link>
                        </header>
                                ...
                                <div className="overflow-hidden">
                                    <div className="p-5 space-y-2 pt-0">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                                            ...
                                            <div className="flex justify-end items-end pt-4"><button type="button" onClick={handleClearFilters} className="flex items-center gap-2 bg-gray-200 text-gray-700 font-semibold px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors h-fit"><FilterX className="h-5 w-5" />Limpar Filtros</button></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
