...
import { PlusCircle, Edit, Trash2, FileText, LayoutTemplate } from 'lucide-react';
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            <header className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 pb-4 border-b">
                ...
                <Link to="/admin/certidoes/novo" className="flex items-center gap-2 bg-blue-600 text-white font-semibold px-4 py-2 rounded-lg shadow-sm hover:bg-blue-700 mt-4 md:mt-0">
