        ...
        <div className="mx-auto">
            ...
            <header className="flex flex-col md:flex-row items-start md:items-center justify-between pb-4">
                <div>
                    ...
                    <h1 className="text-3xl font-bold text-[#4a4e51]">Modelos de Certidão</h1>
