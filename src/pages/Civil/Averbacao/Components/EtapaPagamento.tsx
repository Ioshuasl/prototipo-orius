...
import { type ProcessoAverbacaoState } from '../EmissaoAverbacao'; // Importando o tipo do processo de averbação

interface EtapaPagamentoProps {
    // A prop é mantida como 'pedido' para manter a assinatura do componente idêntica,
    // mas internamente trataremos como 'processo'.
...
export default function EtapaPagamento({ pedido, setPedido, onConfirmarPagamento, onVoltar }: EtapaPagamentoProps) {
    ...
    // Ajuste na desestruturação para buscar 'valores' diretamente do objeto 'pedido' (nosso 'processo')
    ...
    // Tela de sucesso após a confirmação do pagamento
