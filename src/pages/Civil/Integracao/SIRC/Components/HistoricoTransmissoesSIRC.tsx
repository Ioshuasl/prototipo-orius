...
export default function HistoricoTransmissoesSIRC({ lotes }: HistoricoTransmissoesProps) {
    const [filtroStatus, setFiltroStatus] = useState<'todos' | 'sucesso' | 'falha'>('todos');
    const [termoBusca, setTermoBusca] = useState('');
    const [loteSelecionado, setLoteSelecionado] = useState<LoteSIRC | null>(null);
